...
const NavColumn: React.FC = () => {
  return (
    <div className={cx(styles.navbar, 'flex col-flex cross-stretch')}>
      <NavLink to="/folios/all" className={cx(styles.navlink, 'flex row-flex space-between cross-center')} activeClassName={cx(styles.activeNavlink)}>
      ...
      <NavLink to="/folios/1" activeClassName={styles.activeGroupCard} className={styles.groupCard}>
        <p>Folio name</p>
      ...
      <NavLink to="/folios/2" activeClassName={styles.activeGroupCard} className={styles.groupCard}>
      ...
      <NavLink to="/folios/3" activeClassName={styles.activeGroupCard} className={styles.groupCard}>
      ...
      <NavLink to="/folios/4" activeClassName={styles.activeGroupCard} className={styles.groupCard}>
